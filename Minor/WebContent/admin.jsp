...
<div style="position:absolute; left:550px; top:200px;">
	...
	<h1 style="font-family: 'Quicksand'; font-size: 32px;"><strong>Welcome ${aNm }</strong></h1>
	<a class="aksh" href="allPatient.jsp">Show All Patients</a><br>
    <a class="aksh" href="allDoctor.jsp">Show All Doctors</a><br>
    <a class="aksh" href="message.jsp">Send Message</a><br>
    <a class="aksh" href="showFB.jsp">Show All Feedback</a><br>
    <a class="aksh" href="caretaker.jsp">Add Caretaker</a>
