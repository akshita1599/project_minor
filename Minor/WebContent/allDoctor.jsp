...
<div style="width:85%; height:700px; position:absolute; top:200px; left:120px; font-family: 'Quicksand';font-size: 23px;">
<table width=100% border=2px>
	<tr>
		<td align=center width=250px;><strong>Doctor Name</strong></td>
		<td align=center width=190px;><strong>Doctor ID</strong></td>
		<td align=center width=160px;><strong>Contact No.</strong></td>
		<td align=center><strong>Hospital Address</strong></td>
		<td align=center><strong>Clinik Address</strong></td>
		<td align=center><strong>More Details</strong></td>
	</tr>
...
try{
	...
	PreparedStatement ps= con.prepareStatement("select dNm,dCliAdd,dHosAdd,dMob,dID from regdoctor");
	ResultSet rs = ps.executeQuery();
	while(rs.next())
	{
		String did=rs.getString(5);	
	...
	<tr align=center>
		...
		<td><a href="docDetails.jsp?dID=<%=did %>">More Info</a></td>
	</tr>
