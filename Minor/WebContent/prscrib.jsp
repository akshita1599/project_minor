...
<form action="givPrs.jsp">
		<table align="center">

			<tr>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;">Enter Medicines</h3></td>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;"><textarea name="med"></textarea></h3></td>
			</tr>

			<tr>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;">Enter Diagnosis</h3></td>
				<td><h3 style="font-family: 'Quicksand';font-size: 30px;"><textarea name="digno"></textarea></h3></td>
            </tr>

			<tr>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;">Enter Patient ID</h3></td>
				<td><h3 style="font-family: 'Quicksand';font-size: 30px;"><input type="text" name="ptID"/></h3></td>
            </tr>
            
			<tr>
				<td colspan="2" align="center"><h3 style="font-family: 'Quicksand';font-size: 30px;"><button class="button">Give Prescription</button></h3></td>
			</tr>
