...
<div style="position:absolute; left:550px; top:200px;">
	...
	<h1 style="font-family: 'Quicksand'; font-size: 32px;"><strong>Welcome ${pNm }</strong></h1>
	<h1 style="font-family: 'Quicksand'; font-size: 30px;">Your PatientID is : ${ptntID }</h1>
	<a class="aksh" href="showPres.jsp">Show Prescription</a><br>
    <a class="aksh" href="notification.jsp">Notification</a><br>
    <a class="aksh" href="patntUpdt.jsp">Update Profile</a>
