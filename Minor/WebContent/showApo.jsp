...
<div style="width:80%; height:700px; position:absolute; top:200px; left:130px; font-family: 'Quicksand';font-size: 23px;">
<table width=100% border=2px>
	<tr>
		...
		<td align=center><strong>Appointment Time</strong></td>
...
String did = (String)session.getAttribute("docID");

try{
	Class.forName("com.mysql.jdbc.Driver");
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/minorpro","root","root");
	
	PreparedStatement ps= con.prepareStatement("select pName,pContct,pPatId,pAppdate,pApTime from regpatient where docID="+did+"");
