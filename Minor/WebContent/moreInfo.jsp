...
String id=request.getParameter("pPatId");
try{
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/minorpro","root","root");
PreparedStatement pst=con.prepareStatement("select pName,pAge,pMarital,pHusNm,pContct,pEmail,pEmer,pAddress,pAller,pMedi,pAlco,pSmoke,pMediHis,pSurHis,pFamHis from regpatient where pPatId="+id+"");
...
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pNm" value="<%=nm %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Age</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pAge" value="<%=age %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Marital Status</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pMar" value="married" readonly/>Married</h3>
<h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pMar" value="unmarried" readonly/>Unmarried</h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Husband/ Father Name</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pHnm" value="<%=hus %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Contact Number</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pContact" value="<%=cont %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Email ID</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pEmail" value="<%=email %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Emergency Contact Number</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pEmcon" value="<%=econ %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Address</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="text" name="pAdd" value="<%=add %>" readonly/></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Allergy</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pAller" value="yes" readonly/>yes</h3>
<h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pAller" value="no" readonly/>no</h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Medication</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pMed" value="yes" readonly/>yes</h3>
<h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pMed" value="no" readonly/>no</h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Alcoholic</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pAlco" value="yes" readonly/>yes</h3>
<h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pAlco" value="no" readonly/>no</h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Smoker</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pSmoke" value="yes" readonly/>yes</h3>
<h3 style="font-family: 'Quicksand';font-size: 20px;"><input type="radio" name="pSmoke" value="no" readonly/>no</h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Medical History</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><textarea name="pMedhis" readonly/><%=medhis %></textarea></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Surgical History</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><textarea name="pSurhis" readonly/><%=surhis %></textarea></h3></td>
</tr>

<tr>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;">Family Medical History</h3></td>
<td><h3 style="font-family: 'Quicksand';font-size: 20px;"><textarea name="pFammed" readonly/><%=fammed %></textarea></h3></td>
</tr>
