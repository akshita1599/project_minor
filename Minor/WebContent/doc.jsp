...
<div style="position:absolute; left:550px; top:230px;">
	...
	<h1 style="font-family: 'Quicksand'; font-size: 32px;"><strong>Welcome ${dNm }</strong></h1>
	<h1 style="font-family: 'Quicksand'; font-size: 30px;">Your DoctorID is : ${docID }</h1>
	<a class="aksh" href="showPtnt.jsp">Show All Patients</a><br>
    <a class="aksh" href="prscrib.jsp">Provide Prescription</a><br>
    <a class="aksh" href="updtDoc.jsp">Update Profile</a><br>
    <a class="aksh" href="showApo.jsp">Show Appointments</a>
