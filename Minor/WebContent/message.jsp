...
<form action="doMsg.jsp">
		<table align="center">

			<tr>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;">Enter PatientID<input type="text" name="ptntID"/></h3></td>
			</tr>

			<tr>
				<td><h3 style="font-family: 'Quicksand';font-size: 28px;">Enter Message<textarea name="adMsg"></textarea></h3></td>
			</tr>

			<tr>
				<td colspan="2" align="center"><h3 style="font-family: 'Quicksand';font-size: 30px;"><button class="button">Send Message</button></h3></td>
			</tr>
